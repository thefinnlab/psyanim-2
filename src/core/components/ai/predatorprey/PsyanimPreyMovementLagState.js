...
export default class PsyanimPreyMovementLagState extends PsyanimFSMState {
    ...
    constructor(fsm) {
        ...
        this.addTransition(PsyanimPreyWanderState, 'movementLagComplete', (value) => value === true);
